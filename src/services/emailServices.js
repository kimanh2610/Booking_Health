...
let getBodyHTMLEmailRemedy = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        result =
            `
        <h3>Xin chào, ${dataSend.patientName}!</h3>
        <p>Bạn nhận được email này vì đã đặt lịch khám bệnh online tại Booking Health thành công.</p>
    ...
    if (dataSend.language === 'en') {
        result = `
        <h3>Dear, ${dataSend.patientName}!</h3>
        <p>You received this email because you booked an online medical appointment at Booking Health success.</p>
        <p></p>
        <div>Booking Heath sincerely thanks!!!</div>
